...
Mit `--uebernehmen` nimmt das Programm die Kontrolle, auch wenn sie jemand hält:
das Tablet, oder ein vom NOT-AUS getöteter Lauf, der sein Lease nicht mehr
zurückgeben konnte. Im Reiter „Fahren“ ist das das Häkchen „🔓 Kontrolle
übernehmen". Eine bewusste Handlung — sie steht als `lease_übernommen` im Lauf.
"""
