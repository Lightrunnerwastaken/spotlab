...
# und eine Frist `time.time()+30` je Kommando lief innerhalb weniger Schritte ab.
# Ohne Echtzeit zaehlt die Frist deshalb auf der Sim-Uhr (`b.uhr()`). Die Marke
